...
#define SW6306_BAT_CHG_CURR_MAX         4500U       //设置充电电池端限流值（单位:mA，范围：100~12000）
...
//操作语法宏，方便添加freeRTOS之类的支持
    ...
    #define SW6306_MUTEX_TAKE   xSemaphoreTake(mutex_i2c_handle, portMAX_DELAY)
    #define SW6306_MUTEX_GIVE   xSemaphoreGive(mutex_i2c_handle)
#endif    
...
#define SW6306_DCHG4_UVLO_2V9       0x04U//放电UVLO单节电压2.9V
